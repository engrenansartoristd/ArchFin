<%-- 
    Document   : selAnoRelatorioFaturamentoMensal
    Created on : May 15, 2023, 10:59:21 PM
    Author     : renan
--%>
...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container-fluid" style="padding-left: 30px;padding-bottom: 0px;margin-bottom: 10px;padding-right: 30px;">
            <form action="relatorioFaturamentoMensal.jsp" target="_blank" name="formCadastro" method="get">
